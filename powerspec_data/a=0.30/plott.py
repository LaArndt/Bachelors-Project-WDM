...
_50eV = np.loadtxt("powerspec_a=0.30_50eV")
_100eV = np.loadtxt("powerspec_a=0.30_100eV")
_1000eV = np.loadtxt("powerspec_a=0.30_1000eV")
_300eV = np.loadtxt("powerspec_a=0.30_300eV")
_500eV = np.loadtxt("powerspec_a=0.30_500eV")
_10000eV = np.loadtxt("powerspec_a=0.30_10000eV")

figure = plt.figure()
plt.title("matter \n at t=2.889 Gyr, a=0.3000", fontsize=15)
...
plt.savefig("powerspectra_a=0.30.png",format="png")
plt.show()
