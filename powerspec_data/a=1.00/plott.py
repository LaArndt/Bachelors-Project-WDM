...
_50eV = np.loadtxt("powerspec_a=1.00_50eV")
_100eV = np.loadtxt("powerspec_a=1.00_100eV")
_1000eV = np.loadtxt("powerspec_a=1.00_1000eV")
_300eV = np.loadtxt("powerspec_a=1.00_300eV")
_500eV = np.loadtxt("powerspec_a=1.00_500eV")
_10000eV = np.loadtxt("powerspec_a=1.00_10000eV")

figure = plt.figure()
plt.title("matter \n at t=14.00 Gyr, a=1.00", fontsize=15)
...
plt.savefig("powerspectra_a=1.00.png", format="png")
plt.show()
