...
_50eV = np.loadtxt("powerspec_a=0.10_50eV")
_100eV = np.loadtxt("powerspec_a=0.10_100eV")
_1000eV = np.loadtxt("powerspec_a=0.10_1000eV")
_300eV = np.loadtxt("powerspec_a=0.10_300eV")
_500eV = np.loadtxt("powerspec_a=0.10_500eV")
_10000eV = np.loadtxt("powerspec_a=0.10_10000eV")

figure = plt.figure()
plt.title("matter \n at t=0.5600 Gyr, a=0.1000", fontsize=15)
...
plt.savefig("powerspectra_a=0.01.png", format="png")
plt.show()
